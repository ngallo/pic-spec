...
docname: pic-prover-verifier-02
category: info
ipr: none
...
**Document:** pic-prover-verifier-02
**Version:** 0.2 (Draft)
...
This document is the **PIC Prover and Verifier Specification**, a subordinate specification of the [PIC Specification](https://github.com/pic-protocol/pic-spec/blob/main/draft/0.2/pic-spec.md). It
...
## The N+1 Executor Problem (Canonical Execution Model)
...
## Cross-Lineage Authority Composition
...
## The Execution Flow as Part of the Security Model
...
## Authority as an Abstract Domain
...
## Canonicalization and Cryptographic Agility
